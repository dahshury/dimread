...
describe("Slider", () => {
	...
	test("gradient variant renders inline start/end labels and the value pill", () => {
		render(
			<Slider
	...
	test("gradient variant fires onCommit with the released value", () => {
		const onCommit = mock<(value: number) => void>(() => undefined);
		render(
			<Slider
